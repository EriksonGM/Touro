...
{
    public partial class ExistenciasConsumiveis : System.Web.UI.Page
    {
        ...
        protected void lvEnttradaStock_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            //var I = Request.QueryString["Id"];

            //if (!string.IsNullOrEmpty(I) && I.ToString() == e.Item.DataItemIndex.ToString())
            //{
            //    lvEnttradaStock.se
            //}
