<%@ Page Title="" Language="C#" MasterPageFile="~/LayOutPanel.master" AutoEventWireup="true" CodeBehind="ExistenciasConsumiveis.aspx.cs" Inherits="Touro.Patrimonio.ExistenciasConsumiveis" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    <asp:ListView ID="lvEnttradaStock" runat="server" DataSourceID="SqlDataSourceEntradaStock" DataKeyNames="Id_EntradaStock" OnDataBound="lvEnttradaStock_DataBound" OnItemDataBound="lvEnttradaStock_ItemDataBound">
        <EmptyDataTemplate>
